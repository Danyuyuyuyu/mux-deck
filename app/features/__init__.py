...
from app.features import browse, files, tracks, mux, extract, preview, misc, fonts, env, subcheck, propedit
...
for _m in (browse, files, tracks, mux, extract, preview, misc, fonts, env, subcheck, propedit):
    _register(_m)

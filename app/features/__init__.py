...
from app.features import browse, files, tracks, mux, extract, preview, misc, fonts, env, subcheck
...
for _m in (browse, files, tracks, mux, extract, preview, misc, fonts, env, subcheck):
    _register(_m)

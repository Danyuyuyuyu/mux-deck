...
class H(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if u.path == "/favicon.ico":
            ...
            self.end_headers()
            return
        if u.path in ("/", "/index.html", "/index-light.html"):
            # 浅色皮肤版本：/index-light.html，与默认 /index.html 并存
            fname = "index-light.html" if u.path == "/index-light.html" else "index.html"
            try:
                with open(os.path.join(BASE, "app", fname), "rb") as f:
